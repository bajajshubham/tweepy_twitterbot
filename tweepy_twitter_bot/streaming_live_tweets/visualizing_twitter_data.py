...
def call_visualizing_twitter_data(api=None):
    ...
    while True:
        ...
        print('''
                    [1] Plot Graph for likes
                    [2] Plot Graph for Retweets
                    [q] Exit
                ''')
        inp = input("Enter: ")
        if inp == "q":
        ...
        num_tweets = int(input("Enter number of tweets to be fetched[>0 and <187]: "))
